  ...
  if (caught.length === 1010) {
    return (
      <div className='congrats'>
        ...
        Congratulations, you've caught every Pokémon! That must have taken you hours... If you want to play again, just head over to your <Link to='/pokedex'>Pokédex</Link> and clear it. Every Pokémon has at least two unique entries, so your experience should be different each time you play through!
      </div>
    )
  }
